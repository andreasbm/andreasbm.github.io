		...
		return [
			...
			css`
                ...
                #sun-overlay {
                    position: absolute;
                    inset: 0;
                    background: radial-gradient(circle at center, rgba(0, 0, 0, 0) 0%, var(--space-500) 100%);
                }
		...
		return html`
			<div id="header-container">
				<header id="header">
                    ...
                    <div id="sun-overlay"></div>
					<div id="content">
						${this.img != null ? html`<img @load="${{handleEvent: this.onAvatarLoaded.bind(this), once: true}}" id="avatar" src="${this.img}" alt="Avatar" loading="lazy"/>` : ""}
